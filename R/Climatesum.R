...
#'
#'   The \code{Climatesum} dataset gives annual climate information for each site during the experiment. 
#'   It is created from \code{Climate} dataset which has daily precipitation (mm) and daily minimum, mean and maximum (air) temperature (°C) for each site. 
#'   From the \code{Climate} dataset, daily precipitation values were summed and daily mean temperature values were averaged within each year for each site. 
